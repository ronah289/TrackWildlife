...
public class App {
    ...
    public static void main(String[] args){
        ...
        get("/create/ranger",(request, response) -> {
            Map<String,Object> model = new HashMap<String, Object>();
            return new ModelAndView(model,"create-ranger.hbs");
        },new HandlebarsTemplateEngine());

        //server record of new ranger
        post("/create/ranger/new",(request, response) -> {
            Map<String,Object> model = new HashMap<String, Object>();
            String name = request.queryParams("name");
            Integer staff_number = Integer.valueOf(request.queryParams("staff_number"));
            Rangers ranger=new Rangers(name, staff_number);
            ranger.save();
            return new ModelAndView(model,"create-ranger.hbs");
        },new HandlebarsTemplateEngine());
        ...
        get("/create/animal",(request, response) -> {
            Map<String,Object> model = new HashMap<String, Object>();
            return new ModelAndView(model,"create-animal.hbs");
        },new HandlebarsTemplateEngine());

        // record new animal data
        ...
        get("/create/sighting",(request, response) -> {
            ...
            return new ModelAndView(model,"create-sighting.hbs");
        },new HandlebarsTemplateEngine());

        // record new sighting data
        ...
        //all locations
        get("/view/location",(request, response) -> {
            Map<String,Object> model = new HashMap<String, Object>();
            model.put("locations",Location.all());
            return new ModelAndView(model,"view-location.hbs");
        },new HandlebarsTemplateEngine());

        //view a location sightings
        ...
        get("/view/rangers",(request, response) -> {
            Map<String,Object> model = new HashMap<String, Object>();
            model.put("rangers",Rangers.all());
            return new ModelAndView(model,"view-ranger.hbs");
        },new HandlebarsTemplateEngine());
        ...
        get("/view/animals",(request, response) -> {
            Map<String,Object> model = new HashMap<String, Object>();
            model.put("animals",Animals.all());
            return new ModelAndView(model,"view-animal.hbs");
        },new HandlebarsTemplateEngine());
        ...
        get("/view/sightings",(request, response) -> {
            ...
            model.put("animals",animals);
            model.put("types",types);
            return new ModelAndView(model,"view-sighting.hbs");
        },new HandlebarsTemplateEngine());
